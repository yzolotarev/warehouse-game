...
| 🗄 Стеллажи | отложено | по контекстам (@дом, @комп), листается по одному |
| 🧱 Паллеты | проекты | критерий готовности + одношаговые шаги в фокус; серия шагов за день — бонус; месяц без движения — заморозка ❄ |
