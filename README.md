...
Интерфейс двуязычный: кнопка **EN/RU** рядом с переключателем темы переводит весь UI
на лету (English interface is one click away); тексты самих задач не трогаются.
