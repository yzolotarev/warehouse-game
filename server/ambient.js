...
(function () {
  ...
  document.addEventListener("DOMContentLoaded", async () => {
    ...
    // В режиме «авто» без кэша это files[0] (см. curSrc); refreshPick ниже
    // потом БЕЗ ожидания подменит на умный выбор. Раньше первый видимый кадр
    // ждал ответа сторожа-LLM (~5с холодным, до 90с при затыке) - чёрный экран.
    if (st.on) mount();
