...
(function () {
  ...
  const PAIRS = [
    ...
    ["😰 У страшной задачи теперь есть кнопка «2 минуты»: очко даётся за начало, а не за завершение. Бросить через две минуты — тоже победа.",
     "😰 Scary tasks now have a «2 minutes» button: the point is for starting, not finishing. Quitting after two minutes is still a win."],
